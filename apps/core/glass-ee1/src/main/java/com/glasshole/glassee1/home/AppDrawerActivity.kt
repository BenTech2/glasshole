...
class AppDrawerActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        drawerBackground = DrawerBackground(
            ...
            enabledPrefKey = com.glasshole.glassee1.BaseSettings.KEY_WALLPAPER_ON_APP_DRAWER,
        )
    ...
    private fun loadLauncherApps(): List<AppEntry> {
        ...
        // Pinned apps come first in pin order; the rest sorted as before.
        val pinned = com.glasshole.glassee1.BaseSettings.getPinnedPackages(this)
    ...
    private fun fwdSign(): Int =
        if (com.glasshole.glassee1.BaseSettings.isNavInverted(this)) -1 else 1
}

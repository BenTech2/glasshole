...
/**
 * Decodes a notification sound ID into a playback action. EE1 mirror
 * of the EE2 file — see that copy for the full design note. Per-app
 * lookup happens in NotificationDisplayActivity before calling
 * [play]; this object is a pure playback helper.
 */

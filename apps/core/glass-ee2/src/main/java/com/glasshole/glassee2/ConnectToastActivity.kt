...
class ConnectToastActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Modern API on 27+ (EE2), flag fallback for the legacy path.
    ...
    override fun finish() {
        ...
        // After the banner goes away, put the glass back to standby so it
        // doesn't sit there on until the system's screen timeout fires.
        // PowerManager.goToSleep is @hide in public SDK — call via reflection.
        try {
            ...
            // Reflective goToSleep blocked — the screen will still go off on
            // the usual SCREEN_OFF_TIMEOUT, just not instantly.
        }
    }
}

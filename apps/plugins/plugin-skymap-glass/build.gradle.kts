...
android {
    namespace = "com.glasshole.plugin.skymap.glass"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.glasshole.plugin.skymap.glass"
        // minSdk 19 — one APK for XE / EE1 / EE2. SkyMap uses
        // standard SensorManager + LocationManager, both available
        // on KitKat.
        minSdk = 19
        targetSdk = 34

 ...
 * settings UI. Values land in [PREFS_NAME] so MediaScanner /
 * CoverFlowActivity / CoverFlowTransformer can read them directly.
 */
class Gallery2PluginService : GlassPluginService() {

    companion object {
        private const val TAG = "Gallery2Plugin"
        const val PREFS_NAME = "gallery2_settings"
    }

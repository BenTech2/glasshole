...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleScannedUrl(url: String) {
        ...
        val intent = when (platform) {
            StreamPlatform.YOUTUBE -> Intent(this, YouTubePlayerActivity::class.java).apply {
                putExtra(YouTubePlayerActivity.EXTRA_VIDEO_ID, StreamResolver.extractYouTubeVideoId(url))
            }

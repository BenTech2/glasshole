...
data class PluginMessage(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is PluginMessage) return false
    ...
    companion object CREATOR : Parcelable.Creator<PluginMessage> {
        override fun createFromParcel(parcel: Parcel): PluginMessage = PluginMessage(parcel)
        override fun newArray(size: Int): Array<PluginMessage?> = arrayOfNulls(size)
    }
}
